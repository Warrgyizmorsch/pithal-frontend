...
import { feedersData } from "@/data/products/feedersData";
      ...
      <main className="min-h-screen bg-white">
        <Container>
          <div className="py-20">
            ...
            <SectionHeader
              eyebrow={feedersData.intro.eyebrow}
              title={feedersData.intro.title}
              highlight={feedersData.intro.highlight}
              subtitle={feedersData.intro.subtitle}
            />
            ...
            <div className="mt-16 grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <p className="text-gray-600 text-lg">{feedersData.description}</p>

                <div>
                  <h3 className="text-xl font-bold text-primary mb-4">Specifications</h3>
                  <div className="grid grid-cols-2 gap-4">
                    {feedersData.specs.map((spec, i) => (
            ...
            <div className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {feedersData.features.map((feature, i) => (
            ...
            <div className="mt-16">
              ...
              <div className="flex flex-wrap gap-3">
                {feedersData.industries.map((industry, i) => (
            ...
            <div className="mt-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {feedersData.relatedProducts.map((product, i) => (
                  <Link
                    key={i}
                    href="/products"
