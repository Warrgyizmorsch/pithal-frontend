...
export const primeBucketData: ProductDetailData = {
  ...
  stats: [
    { label: "Excavator", value: "10 - 50", unit: "Ton", description: "Standard carrier machine range", icon: "truck" },
    { label: "Feed Size", value: "Up to 1050", unit: "mm (Max)", description: "Handles large debris", icon: "feeder" },
    { label: "Oil Flow", value: "80 - 180", unit: "LPM", description: "Standard excavator circuit", icon: "zap" },
  ...
  specificationsSection: {
    ...
    columns: [
      ...
      { label: "Max Feed Size", key: "maxFeedSize" },
      { label: "Adjustable Output Size", key: "outputSize" },
      { label: "Oil Flow", key: "oilFlow" },
      { label: "Operating Pressure", key: "operatingPressure" },
      { label: "Weight", key: "weight", emphasis: "primary" },
    ],
  ...
  specifications: [
    {
      model: "PBC-10",
      excavatorSize: "10 – 18 Ton",
      bucketCapacity: "0.40 m³",
      maxFeedSize: "650 mm",
      outputSize: "20 – 120 mm",
      oilFlow: "80 – 100 LPM",
      operatingPressure: "220 – 250 Bar",
      weight: "1,850 kg",
    },
    {
      model: "PBC-20",
      excavatorSize: "18 – 26 Ton",
    ...
    {
      model: "PBC-30",
      excavatorSize: "26 – 35 Ton",
      bucketCapacity: "0.80 m³",
      maxFeedSize: "900 mm",
      outputSize: "20 – 150 mm",
      oilFlow: "120 – 150 LPM",
      operatingPressure: "250 – 280 Bar",
      weight: "3,600 kg",
    },
    {
      model: "PBC-40",
      excavatorSize: "35 – 50 Ton",
      bucketCapacity: "1.10 m³",
      maxFeedSize: "1050 mm",
      outputSize: "20 – 160 mm",
      oilFlow: "150 – 180 LPM",
      operatingPressure: "250 – 300 Bar",
      weight: "4,800 kg",
    },
  ],
  industriesSection: {
