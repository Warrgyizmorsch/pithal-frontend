...
export const primeUltraRockData: ProductDetailData = {
  ...
  hero: {
    ...
    image: {
      src: "/product-hero/new Prime Ultra Rock banner.webp",
  ...
  stats: [
    { label: "Capacity", value: "250 - 1000", unit: "TPH", description: "High-volume primary crushing", icon: "gauge" },
    { label: "Max Feed", value: "Up to 1000", unit: "mm", description: "Handles massive rock feed", icon: "feeder" },
    { label: "Motor Power", value: "160 - 450", unit: "kW", description: "Heavy-duty drive options", icon: "zap" },
    { label: "Feed Opening", value: "Up to 1800 x 1200", unit: "mm", description: "Large feed chamber", icon: "ruler" },
  ...
  intro: {
    ...
    callouts: [
      {
        label: "High Stroke Mechanism",
        text: "Constant high stroke for superior feed acceptance and crushing power",
        position: "leftTop",
        layout: {
          dotClass: "left-[44%] top-[25%]",
          cardClass: "left-[1%] top-[2%] w-[172px]",
        },
      },
      {
        label: "Deep Feed Chamber",
        text: "Deep cavity design for large rock feed acceptance",
        position: "rightTop",
        layout: {
          dotClass: "right-[38%] top-[14%]",
          cardClass: "right-[1%] top-[2%] w-[172px]",
        },
      },
      {
        label: "Hydraulic CSS",
        text: "Automatic setting adjustment and overload protection",
        position: "rightMiddle",
        layout: {
          dotClass: "right-[18%] top-[32%]",
          cardClass: "right-[1%] top-[28%] w-[176px]",
        },
      },
      {
        label: "Flywheel Drive",
        text: "Precision-balanced flywheel for smooth high-inertia operation",
        position: "rightBottom",
        layout: {
          dotClass: "right-[24%] top-[62%]",
          cardClass: "right-[1%] top-[60%] w-[176px]",
        },
      },
      {
        label: "Robust Frame",
        text: "Heavy-duty frame built for extreme quarrying and mining duty",
        position: "bottomCenter",
        layout: {
          dotClass: "left-[32%] top-[86%]",
          cardClass: "left-[22%] top-[86%] w-[180px]",
        },
      },
    ],
    applications: {
  ...
  specificationsSection: {
    ...
    columns: [
      ...
      { label: "Feed Opening (mm)", key: "feedOpening" },
  ...
  specifications: [
    {
      model: "PMUR-110",
      feedOpening: "1100 x 750 mm",
      maxFeedSize: "600 mm",
      capacity: "250 – 400 TPH",
      motorPower: "160 – 200 kW",
    },
    {
      model: "PMUR-130",
      feedOpening: "1300 x 900 mm",
      maxFeedSize: "750 mm",
      capacity: "350 – 600 TPH",
      motorPower: "200 – 280 kW",
    },
    {
      model: "PMUR-150",
      feedOpening: "1500 x 1000 mm",
      maxFeedSize: "850 mm",
      capacity: "280 – 750 TPH",
      motorPower: "280 – 355 kW",
    },
    {
      model: "PMUR-180",
      feedOpening: "1800 x 1200 mm",
      maxFeedSize: "1000 mm",
      capacity: "650 – 1000 TPH",
      motorPower: "355 – 450 kW",
    },
  ],
  industriesSection: {
  ...
  relatedMachines: [
    { title: "PRIME CONE CRUSHER", description: "High-efficiency secondary crushing with excellent particle shape.", image: { src: "/images/products/related-products/cone-crusher.png", alt: "Prime Cone Crusher" }, category: "Secondary", icon: "cone", href: "/products/cone-crushers", actionLabel: "VIEW DETAILS" },
    { title: "PRIME VSI CRUSHER", description: "Advanced crushing technology for superior cubical shape and reliability.", image: { src: "/images/products/related-products/vsi-crusher.png", alt: "Prime VSI Crusher" }, category: "Crushing", icon: "vsi", href: "/products/vsi-crushers", actionLabel: "VIEW DETAILS" },
