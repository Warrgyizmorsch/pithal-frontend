        ...
        <div className="mb-8 grid items-end gap-8 lg:grid-cols-[0.86fr_1.32fr]">
          <header>
            ...
            <div className="mt-4 max-w-[28rem] text-sm leading-7 text-text-dark sm:text-base">
              ...
              <p className="flex sm:inline-flex items-center gap-2 rounded-2xl sm:rounded-full border border-red-500/30 bg-red-500/5 px-4 py-2 text-[13px] sm:text-[15px] font-bold text-red-600 mt-3">
