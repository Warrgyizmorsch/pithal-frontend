        ...
        <div className="mb-8 grid items-end gap-8 lg:grid-cols-[0.86fr_1.32fr]">
          <header>
            ...
            <div className="mt-4 max-w-[28rem] text-sm leading-7 text-text-dark sm:text-base">
              At Pithal Machines, we deliver reliable crushing and screening equipment engineered for high productivity, efficient operation and long-term performance across demanding industries.
            </div>
