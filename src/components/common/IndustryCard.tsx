...
export function IndustryCard({
  ...
  return (
    <article className="group image-hover relative min-h-[14.2rem] overflow-hidden rounded-xl border border-primary/90 bg-primary-dark sm:min-h-[15.2rem]">
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-end gap-4 px-5 pb-4 pt-12 text-white sm:pb-5">
        <Icon aria-hidden className="mb-0.5 shrink-0 text-secondary" size={45} strokeWidth={1.8} />
        <div>
