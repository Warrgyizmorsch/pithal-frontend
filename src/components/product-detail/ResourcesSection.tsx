          ...
          {resources.map((resource) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 justify-between py-1">
                ...
                <a 
                  href={resource.href}
                  className="inline-flex items-center justify-center gap-2 border border-[#fa5902] text-[#fa5902] hover:bg-[#fa5902]/5 transition-colors font-bold uppercase rounded-lg px-4 py-2 mt-4 text-[11px] tracking-[0.08em] w-fit"
                >
